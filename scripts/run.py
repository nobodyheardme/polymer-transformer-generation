...
eval_script = load_module('eval', Path('scripts') / 'eval.py')
trainer_script = load_module('train', Path('scripts') / 'train.py')
sampler_script = load_module('generate', 'generate.py')
...
def get_parser():
    ...
    parser.add_argument('--metrics', type=str, default='outputs/metrics.csv',
